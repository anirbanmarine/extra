...
```mermaid
graph TD
    A[IMO: Tier I] -->|Goals| B[IMO: Tier II]
    B -->|Functional Requirements| C[IACS/Class Societies: Tier III]
    C -->|Verification of Compliance| D[Industry: Tier IV]
    D -->|Design and Construction Standards| C
```
